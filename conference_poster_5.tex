...
When the project has been completed it will be open sourced so that anyone can work on it and improve the application to make it better suite peoples needs, The development has taken a agile approach using XP and FDD to ensure robust and usable code.
